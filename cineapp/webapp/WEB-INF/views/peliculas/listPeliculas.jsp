...
<spring:url var="urlPeliculas" value="/peliculas" />
<spring:url var="crearPelicula" value="/peliculas/create" />
<spring:url var="urlEdit" value="/peliculas/edit" />
<spring:url var="urlDelete" value="/peliculas/delete" />
...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<a href="${crearPelicula }" class="btn btn-success" role="button"
