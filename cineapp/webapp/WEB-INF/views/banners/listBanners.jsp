...
<spring:url var="crearBanner" value="/banners/create"/>
<spring:url var="editBanner" value="/banners/edit"/>
<spring:url var="deleteBanner" value="/banners/delete"/>
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach items="${banners }" var="banner">
					<tr>
						...
						<td><a href="${editBanner}/${banner.id}" class="btn btn-success btn-sm" role="button"
							title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
							<a href="${deleteBanner}/${banner.id}" class="btn btn-danger btn-sm" role="button"
